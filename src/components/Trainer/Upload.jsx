      ...
      <div className="w-full max-w-3xl h-60 ">
        ...
        <form className="mt-4 space-y-4 text-black/70">
          <div className="shadow px-4 pb-3 p-2 rounded bg-white flex flex-col">
            ...
            <select className="py-1 border-2 border-gray-300  rounded px-2 mt-1">
          ...
          <div className="shadow px-4 pb-4 p-2 rounded bg-white flex flex-col">
            ...
            <input
              type="text"
              className="py-1 border-2 border-gray-300 rounded px-2 mt-1 placeholder:text-sm"
          ...
          <div className="shadow px-4 pb-4 p-2 h-44 rounded bg-white flex flex-col">
            ...
            />
            <div
              className=" flex flex-col h-44  py-1 border-2 border-dotted border-blue-400 bg-blue-50 rounded px-2 mt-2 placeholder:text-sm text-center justify-center items-center"
