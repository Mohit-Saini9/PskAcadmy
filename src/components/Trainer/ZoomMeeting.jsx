    ...
    <div className=" w-full md:max-w-3xl justify-center mx-auto pb-4">
      ...
      <div className="flex flex-col md:flex-row gap-4 mt-4">
        <div className="w-full">
          <form className="shadow bg-white rounded p-3 px-3 w-full  space-y-3  text-black/70 font-semibold ">
        ...
        <div className="md:w-1/2 space-y-4">
          <div className="shadow   bg-white p-2 rounded-md px-3 space-y-2 pb-6 ">
            ...
            <div className="bg-green-50 p-2 border border-green-200 rounded-md px-3 ">
              <h6 className="text-xs font-medium text-black/50">This Month</h6>
