  ...
  return (
    <div className="w-screen max-w-screen-lg  px-4  ">
      ...
      <div className="flex flex-wrap mt-6   gap-4 px-2 ">
        <div className="md:w-72   w-full sm:w-64  p-4 min-h-[140px] shadow rounded-md bg-white">
        ...
        <div className="md:w-72   w-full sm:w-64 min-h-[140px] p-4 shadow h-28 rounded-md bg-white">
          <div className="flex justify-between  p-3 text-black/60">
            In Progress
